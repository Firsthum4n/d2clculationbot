...
def matches_test_2():
    ...
    with open('main/calc_bot/test_data_2.json', 'w+') as f:
        json.dump(test_data_x, f, indent=4)

    print("Test data saved to test_data_2.json")
    return test_data_x, test_data_y

def matches_result_2():
    test_data_x = []
    test_data_y = []
    with open('main/calc_bot/test_data_2.json', 'r') as f:
        result = json.load(f)
        for i in result:
