...
def train_model(request):
    ...
    model.load_state_dict(torch.load('main/calc_bot/actual_models/dota_model_ver0_8.pth'))

    criterion = nn.BCELoss()
    optimizer = torch.optim.AdamW(model.parameters(), lr=1e-6, weight_decay=1e-14)
    ...
    torch.save(model.state_dict(), 'main/calc_bot/actual_models/dota_model_ver0_9.pth')


    model.load_state_dict(torch.load('main/calc_bot/actual_models/dota_model_ver0_9.pth'))
