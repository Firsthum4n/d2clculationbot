"""
Django settings for d2calcbot project.
...
SECRET_KEY = 'django-insecure-+)g(0g+=!#i%*coegez9^-*u6n5=o+fv7qd3#_iws#lql$=2sn'
...
WSGI_APPLICATION = 'd2calcbot.wsgi.application'
